...
<div class="card text-center" style="padding:48px">
  <div style="width:56px;height:56px;border-radius:50%;background:#f0ffe6;display:flex;align-items:center;justify-content:center;margin:0 auto 16px">
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#4a7c00" stroke-width="1.8"><path d="M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/></svg>
  </div>
