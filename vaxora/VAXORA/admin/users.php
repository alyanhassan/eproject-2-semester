        ...
        <div class="table-responsive">
            <table class="table mb-0">
                ...
                <tr>
                    ...
                    <td class="text-center"><span class="badge bg-primary bg-opacity-15 text-primary"><?= $u['children_count'] ?></span></td>
                    <td class="text-center"><span class="badge bg-info bg-opacity-15 text-info"><?= $u['total_appts'] ?></span></td>
