...
$dashNav   = [
    ...
    ['label'=>'Reports',           'key'=>'reports',   'url'=>'/admin/reports.php',          'icon'=>'<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/></svg>'],
    ...
    ['label'=>'Parent Requests',   'key'=>'requests',  'url'=>'/admin/requests.php',         'icon'=>'<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M18 8h1a4 4 0 010 8h-1"/><path d="M2 8h16v9a4 4 0 01-4 4H6a4 4 0 01-4-4V8z"/></svg>'],
    ...
    ['label'=>'Booking Details',   'key'=>'bookings',  'url'=>'/admin/bookings.php',         'icon'=>'<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2"/><rect x="9" y="3" width="6" height="4" rx="1"/></svg>'],
...
$iconUsers    = '<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><path d="M17 21v-2a4 4 0 00-4-4H5a4 4 0 00-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 00-3-3.87M16 3.13a4 4 0 010 7.75"/></svg>';
$iconHospital = '<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><path d="M3 9l9-7 9 7v11a2 2 0 01-2 2H5a2 2 0 01-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg>';
$iconClock    = '<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg>';
$iconCheck    = '<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><polyline points="20 6 9 17 4 12"/></svg>';
?>

<div class="widget-grid">
    <div class="widget">
        <div class="widget-icon lime" style="color:#4a7c00"><?= $iconUsers ?></div>
        <div class="widget-value"><?= $totalChildren ?></div>
        <div class="widget-label">Registered Children</div>
    </div>
    <div class="widget">
        <div class="widget-icon blue" style="color:#2467E3"><?= $iconHospital ?></div>
        <div class="widget-value"><?= $totalHospitals ?></div>
        <div class="widget-label">Active Hospitals</div>
    </div>
    <div class="widget">
        <div class="widget-icon orange" style="color:#b56b00"><?= $iconClock ?></div>
        <div class="widget-value"><?= $pendingRequests ?></div>
        <div class="widget-label">Pending Requests</div>
    </div>
    <div class="widget">
        <div class="widget-icon lime" style="color:#4a7c00"><?= $iconCheck ?></div>
...
<div class="grid-2" style="gap:24px;margin-bottom:24px">
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        <td>
                            <?= e($appt['child_name']) ?>
                            <br><small class="text-muted"><?= e($appt['parent_name']) ?></small>
                        </td>
                    ...
                    <tr><td colspan="5" class="text-center text-muted" style="padding:24px">No appointments yet</td></tr>
                    <?php endif; ?>
                </tbody>
            </table>
        </div>
    ...
    <div>
        <div class="card mb-16">
            <h3 style="font-size:1rem;margin-bottom:18px">Quick Stats</h3>
            <?php
            $stats = [
                ['label'=>'Total Parents',          'val'=>$totalParents],
                ['label'=>'Available Vaccines',     'val'=>$totalVaccines],
                ['label'=>'Active Hospitals',       'val'=>$totalHospitals],
                ['label'=>'Completed Vaccinations', 'val'=>$completedVax],
                ['label'=>'Pending Reviews',        'val'=>$pendingReviews],
            ];
            foreach ($stats as $s): ?>
        ...
        <div class="card">
            ...
            <div style="display:flex;flex-direction:column;gap:10px">
                <a href="<?= SITE_URL ?>/admin/hospitals.php" class="btn btn-primary btn-sm">+ Add Hospital</a>
                <a href="<?= SITE_URL ?>/admin/vaccines.php"  class="btn btn-outline-dark btn-sm">Manage Vaccines</a>
                <a href="<?= SITE_URL ?>/admin/requests.php"  class="btn btn-outline-dark btn-sm">
                    Review Requests
                    <?php if ($pendingRequests > 0): ?>
                    <span class="badge badge-orange" style="margin-left:6px"><?= $pendingRequests ?></span>
                    <?php endif; ?>
                </a>
                <a href="<?= SITE_URL ?>/admin/reviews.php"   class="btn btn-outline-dark btn-sm">
                    Manage Reviews
                    <?php if ($pendingReviews > 0): ?>
                    <span class="badge badge-yellow" style="margin-left:6px"><?= $pendingReviews ?></span>
                    <?php endif; ?>
                </a>
            </div>
        </div>
