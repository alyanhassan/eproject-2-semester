...
<div class="row g-3 mb-4">
    <?php
    $qa = [
        ['/admin/manage_hospitals.php', 'fas fa-hospital',      'Manage Hospitals', $stats['hospitals'].' active',  '#7c3aed','#f5f3ff'],
        ['/admin/manage_vaccines.php',  'fas fa-vial',          'Manage Vaccines',  $stats['vaccines'].' types',    '#10b981','#f0fdf4'],
        ['/admin/appointments.php',     'fas fa-calendar-check','Appointments',     $stats['pending'].' pending',   '#f59e0b','#fffbeb'],
        ['/admin/inquiries.php',        'fas fa-envelope',      'Inquiries',        $stats['inquiries'].' unread',  '#ef4444','#fef2f2'],
    ];
    foreach ($qa as $a): ?>
    <div class="col-6 col-md-3">
        <a href="<?= $a[0] ?>" class="card p-3 text-decoration-none d-flex align-items-center gap-3">
            ...
            <div>
                <div class="fw-semibold" style="font-size:0.88rem;color:#1e1b4b;"><?= $a[2] ?></div>
...
<div class="row g-4 mb-4">
    ...
    <div class="col-md-7">
        <div class="card chart-card h-100">
            <div class="card-header"><i class="fas fa-hospital me-2" style="color:#0ea5e9;"></i>Top Hospitals by Vaccinations</div>
            <div class="card-body">
                <?php if ($topHospitals): ?>
                    ...
                    <div class="mb-3">
                        <div class="d-flex justify-content-between mb-1">
                            ...
                            <span class="badge" style="background:#f5f3ff;color:#7c3aed;"><?= $h['cnt'] ?></span>
                        </div>
                        <div class="progress" style="height:6px;border-radius:4px;background:#f3f4f6;">
                            <?php $w = $max > 0 ? round(($h['cnt']/$max)*100) : 0; ?>
                            <div class="progress-bar" style="width:<?= $w ?>%;background:linear-gradient(90deg,#7c3aed,#0ea5e9);border-radius:4px;"></div>
                        </div>
                    </div>
                    <?php endforeach; ?>
                <?php else: ?>
        ...
        <div class="table-responsive">
            <table class="table table-hover mb-0">
                ...
                <tr>
                    ...
                    <td><span class="badge" style="background:#f5f3ff;color:#7c3aed;border:1px solid rgba(124,58,237,0.2);font-size:0.72rem;"><?= htmlspecialchars($r['vaccine_name']) ?></span></td>
