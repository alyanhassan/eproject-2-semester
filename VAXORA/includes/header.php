            ...
            <ul class="navbar-nav ms-auto align-items-center gap-1">
                ...
                <li class="nav-item ms-2">
                    <div class="d-flex align-items-center gap-2">
                        <div class="rounded-circle d-flex align-items-center justify-content-center" style="width:32px;height:32px;background:rgba(124,58,237,0.3);font-size:0.8rem;color:#c4b5fd;">
