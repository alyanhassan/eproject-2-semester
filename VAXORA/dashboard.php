...
<div class="container-fluid py-4 px-4">
        ...
        <div class="row align-items-center" style="position:relative;z-index:1;">
            <div class="col-md-8">
                <div class="d-flex align-items-center gap-3 mb-3">
                    <div style="width:54px;height:54px;background:rgba(124,58,237,0.4);border-radius:50%;display:flex;align-items:center;justify-content:center;font-size:1.4rem;border:2px solid rgba(124,58,237,0.5);">
                        <i class="fas fa-user-circle"></i>
                    </div>
                    <div>
                        <div style="font-size:0.8rem;color:#a78bfa;font-weight:500;">Welcome back,</div>
                        <h3 class="fw-bold mb-0"><?= htmlspecialchars($first_name) ?> 👋</h3>
                    </div>
                </div>
                <p style="color:#c4b5fd;font-size:0.9rem;max-width:460px;margin:0;">
        ...
        <div class="row g-3">
            ...
            <div class="col-6 col-lg-3">
                <div class="card p-3 text-center h-100">
                    ...
                    <div class="mt-2 d-flex gap-1">
                        ...
                        <a href="/certificate.php?child_id=<?= $c['child_id'] ?>" class="btn btn-xs flex-fill" style="font-size:0.72rem;padding:4px;background:#f5f3ff;color:#7c3aed;border:1px solid rgba(124,58,237,0.2);">Cert</a>
                    </div>
                </div>
            </div>
            <?php endforeach; ?>
            <div class="col-6 col-lg-3">
                <a href="/add_child.php" class="card p-3 text-center h-100 text-decoration-none d-flex align-items-center justify-content-center flex-column" style="border:2px dashed #d1d5db;min-height:160px;">
                    <div style="width:48px;height:48px;background:#f5f3ff;border-radius:50%;display:flex;align-items:center;justify-content:center;margin-bottom:8px;">
        ...
        <div class="col-lg-6">
            <div class="card h-100">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <span class="fw-semibold"><i class="fas fa-calendar-check me-2" style="color:#7c3aed;"></i>Upcoming Appointments</span>
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover mb-0">
                            ...
                            <tr>
                                ...
                                <td><span class="badge" style="background:#f5f3ff;color:#7c3aed;border:1px solid rgba(124,58,237,0.2);"><?= htmlspecialchars($a['vaccine_name']) ?></span></td>
    ...
    <div class="row g-3 mt-2">
        ...
        <?php
        $quicklinks = [
            ['/book_appointment.php',     'fas fa-calendar-plus', 'Book Appointment',   '#7c3aed', '#f5f3ff'],
            ['/vaccination_history.php',  'fas fa-notes-medical', 'Vaccination History','#10b981', '#f0fdf4'],
            ['/children.php',             'fas fa-child',         'My Children',        '#0ea5e9', '#f0f9ff'],
            ['/contact.php',              'fas fa-headset',       'Get Support',        '#f59e0b', '#fffbeb'],
        ];
        ...
        <div class="col-6 col-md-3">
            <a href="<?= $ql[0] ?>" class="card p-3 d-flex flex-row align-items-center gap-3 text-decoration-none">
                ...
                <span class="fw-semibold" style="font-size:0.85rem;color:#1e1b4b;"><?= $ql[3] ?></span>
            </a>
        </div>
        <?php endforeach; ?>
    </div>
